...
<head>
    ...
    <title>Password Reset Admin Page</title>
    <!-- CSS files -->
                            ...
                            <div class="input-group input-group-flat">
                                ...
                                <span class="input-group-text">
                                    <a href="#" class="link-secondary toggle-password" title="Show password"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" id="togglePassword"
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" name="password_confirmation" id="password" required
                                    ...
                                    placeholder="Your password" autocomplete="off">
                                <span class="input-group-text">
                                    <a href="#" class="link-secondary toggle-confirm-password" title="Show password"
                                        data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/eye -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" id="togglePassword"
                                            width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" fill="none" stroke-linecap="round"
